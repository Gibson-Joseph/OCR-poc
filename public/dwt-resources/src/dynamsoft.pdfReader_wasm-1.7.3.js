...
var ImageIOModule = (function () {
  ...
  return function (ImageIOModule) {
    ...
    var STACK_BASE = 1989792,
      DYNAMIC_BASE = 7232672,
      DYNAMICTOP_PTR = 1989600;
    ...
    var ___tm_current = 1989632;
    var ___tm_timezone = (stringToUTF8("GMT", 1989680, 4), 1989680);
    ...
    var _PdfReaderDeletePdfPage = (Module["_PdfReaderDeletePdfPage"] =
      function () {
        return Module["asm"]["_PdfReaderDeletePdfPage"].apply(null, arguments);
      });
    ...
    var _PdfReaderFreeLoadedFont = (Module["_PdfReaderFreeLoadedFont"] =
      function () {
        return Module["asm"]["_PdfReaderFreeLoadedFont"].apply(null, arguments);
      });
    var _PdfReaderGetAttachment = (Module["_PdfReaderGetAttachment"] =
      function () {
        return Module["asm"]["_PdfReaderGetAttachment"].apply(null, arguments);
      });
    var _PdfReaderGetAttachmentCount = (Module["_PdfReaderGetAttachmentCount"] =
      function () {
    ...
    var _PdfReaderGetModifiedPdf = (Module["_PdfReaderGetModifiedPdf"] =
      function () {
        return Module["asm"]["_PdfReaderGetModifiedPdf"].apply(null, arguments);
      });
    var _PdfReaderGetPageAnnot = (Module["_PdfReaderGetPageAnnot"] =
      function () {
        return Module["asm"]["_PdfReaderGetPageAnnot"].apply(null, arguments);
      });
    var _PdfReaderGetPageContentType = (Module["_PdfReaderGetPageContentType"] =
      function () {
    ...
    var _PdfReaderGetPageCount = (Module["_PdfReaderGetPageCount"] =
      function () {
        return Module["asm"]["_PdfReaderGetPageCount"].apply(null, arguments);
      });
    ...
    var _PdfReaderGetPageInfo = (Module["_PdfReaderGetPageInfo"] = function () {
      return Module["asm"]["_PdfReaderGetPageInfo"].apply(null, arguments);
    });
    var _PdfReaderGetPdfInfo = (Module["_PdfReaderGetPdfInfo"] = function () {
      return Module["asm"]["_PdfReaderGetPdfInfo"].apply(null, arguments);
    });
    var _PdfReaderGetPermission = (Module["_PdfReaderGetPermission"] =
      function () {
        return Module["asm"]["_PdfReaderGetPermission"].apply(null, arguments);
      });
    ...
    var _PdfReaderInsertBlankPdfPage = (Module["_PdfReaderInsertBlankPdfPage"] =
      function () {
    ...
    var _PdfReaderMergePdfPage = (Module["_PdfReaderMergePdfPage"] =
      function () {
        return Module["asm"]["_PdfReaderMergePdfPage"].apply(null, arguments);
      });
    var _PdfReaderPageAddAnnot = (Module["_PdfReaderPageAddAnnot"] =
      function () {
        return Module["asm"]["_PdfReaderPageAddAnnot"].apply(null, arguments);
      });
    var _PdfReaderPageAddImage = (Module["_PdfReaderPageAddImage"] =
      function () {
        return Module["asm"]["_PdfReaderPageAddImage"].apply(null, arguments);
      });
    var _PdfReaderPageAddPath = (Module["_PdfReaderPageAddPath"] = function () {
      return Module["asm"]["_PdfReaderPageAddPath"].apply(null, arguments);
    });
    var _PdfReaderPageAddText = (Module["_PdfReaderPageAddText"] = function () {
      return Module["asm"]["_PdfReaderPageAddText"].apply(null, arguments);
    });
    ...
    var _PdfReaderPageRotateLeft = (Module["_PdfReaderPageRotateLeft"] =
      function () {
        return Module["asm"]["_PdfReaderPageRotateLeft"].apply(null, arguments);
      });
    ...
    var _PdfReaderPageSetCropBox = (Module["_PdfReaderPageSetCropBox"] =
      function () {
        return Module["asm"]["_PdfReaderPageSetCropBox"].apply(null, arguments);
      });
    var _PdfReaderReadPdfPageToImage = (Module["_PdfReaderReadPdfPageToImage"] =
      function () {
    ...
    var _PdfReaderSplitPdfPage = (Module["_PdfReaderSplitPdfPage"] =
      function () {
        return Module["asm"]["_PdfReaderSplitPdfPage"].apply(null, arguments);
      });
    ...
    Module["__ZZNK8CFX_Font17LoadGlyphPathImplEjjE9ft_matrix"] = 1797824;
    Module[
...
!(function (e, t) {
  ...
  class O extends class {
    ...
    process(e) {
      ...
      switch (a.func) {
        ...
        case "destroy":
          r.wasmMemoryPtr &&
            ((e.wasmMemoryPtr = r.wasmMemoryPtr), (r.wasmMemoryPtr = null)),
            this._destroy(e);
          break;
        case "terminate":
          return (
        ...
        case "LoadPdf":
          e.wasmMemoryPtr &&
            ((r.wasmMemoryPtr = e.wasmMemoryPtr), (e.wasmMemoryPtr = null)),
        ...
        case "ReadPdfPage":
          !(function () {
            let e,
              ...
              r = JSON.parse(t),
              i = [];
            if (0 === r.errorCode && "Successful." === r.errorMessage)
              if (
                (r.imageInfos[0].imageType === l.IT_BMP
                  ...
                  ? (e = "png")
                  : r.imageInfos[0].imageType === l.IT_RGBA && (e = "rgba"),
                (r.imageData = []),
                (r.MD5 = []),
                ...
                for (let e = 0; e < r.imageCount; e++)
                  r.imageData[e] = new Uint8ClampedArray(i[e]);
              }
            a.params.returnType != m.RT_BASE64 &&
              1 === r.imageCount &&
              (r.imageData = r.imageData[0]),
              (s = r);
            for (let e = 0; e < r.imageCount; e++) n.FreeReservedData(e);
          })();
          break;
        case "GetCurrentData":
          s = n.GetCurrentData();
        ...
        case "UnloadPdf":
          r.wasmMemoryPtr &&
            ((e.wasmMemoryPtr = r.wasmMemoryPtr), delete r.wasmMemoryPtr),
            n.UnloadPdf();
          break;
        case "GetWasmVersion":
          s = n.GetWasmVersion();
          ...
          !(function () {
            ...
            if (void 0 === c[e]) {
              ...
              (t =
                ...
                i.FS.writeFile(t + "/" + e, new Uint8Array(a.params.input[1]), {
                  flags: "w+",
                }),
                (c[e] = !0);
            }
      ...
      let u,
        f = { id: a.id, func: a.func, result: s, memSize: i.HEAPU8.length };
      if (a.params.srcBuffer) {
        "string" == typeof f.result && (f.result = JSON.parse(f.result)),
  ...
  class J {
    ...
    static base64DecToArr(e, a) {
      let s = e.replace(/[^A-Za-z0-9\+\/]/g, ""),
        r = s.length,
        n = a ? Math.ceil(((3 * r + 1) >>> 2) / a) * a : (3 * r + 1) >>> 2,
        i = new Uint8Array(n);
      for (let e, a, o = 0, l = 0, m = 0; m < r; m++)
        if (
          ((a = 3 & m),
          (o |= t(this, g, "m", y).call(this, s.charCodeAt(m)) << (18 - 6 * a)),
          3 === a || r - m == 1)
        ) {
          for (e = 0; e < 3 && l < n; e++, l++)
            i[l] = (o >>> ((16 >>> e) & 24)) & 255;
  ...
  (w = new WeakMap()),
    ...
    (v = function (r, n) {
      ...
      a(
        this,
        M,
        J.buildWasmFileName(r.prefixName, r.ver, s.wasmExtension, !1),
        "f"
      ),
        t(this, h, "m", S).call(this, n, "loading " + t(this, M, "f") + "...");
      ...
      let c = {
        ...
        INITIAL_MEMORY:
          1024 *
          (null !== (i = n.params.initMemory) && void 0 !== i ? i : 32) *
          1024,
        instantiateWasm: function (a, s) {
          if (m.wasmModule)
            return WebAssembly.instantiate(m.wasmModule, a)
              .then(
                function (e) {
                  t(o, h, "m", R).call(o, n, "instantiate with wasm module"),
                    s(e, m.wasmModule);
                },
                function (e) {
                  (e += ""),
              ...
              });
          {
            ...
            let l = function (i) {
              return e(this, void 0, void 0, function* () {
                try {
                  const e = C.fetchRetry(
                      t(o, b, "f") + t(o, M, "f"),
                      t(o, P, "f"),
                      function (e, a) {
                        return t(o, h, "m", R).call(o, n, e), !0;
                      },
                      n
                    ),
                    r = yield e,
                    i = yield r.arrayBuffer(),
                    l = yield WebAssembly.instantiate(i, a);
                  return (m.wasmModule = l.module), s(l.instance, l.module), l;
                } catch (e) {
                  if (
                    (t(o, h, "m", R).call(o, n, "wasm instantiate 1 failed: "),
                    t(o, h, "m", R).call(o, n, JSON.stringify(e)),
                    t(o, h, "m", R).call(
                      o,
                      n,
        ...
        onRuntimeInitialized: function () {
          return e(this, void 0, void 0, function* () {
            t(o, h, "m", S).call(
              o,
              n,
              r.name + " wasm initialized, cost " + (Date.now() - l) + " ms"
            ),
              m.resolve();
          });
        },
            ...
            .then(
              function (e) {
                t(i, h, "m", S).call(
                  i,
                  r,
                  l + " initialized, cost " + (Date.now() - m) + " ms"
                ),
                  null === c.wasmModule
                    ? (null != t(i, w, "f").LDSO.loadedLibsByName
                        ? delete t(i, w, "f").LDSO.loadedLibsByName[l]
                        : null != t(i, w, "f").LDSO.loadedLibNames &&
                          delete t(i, w, "f").LDSO.loadedLibNames[l],
                      t(i, h, "m", R).call(
                        i,
                        r,
                        "wasm is null, attempt " + s + ", retries: " + u
                      ),
                      s < u
                        ? p(s)
                        : o.reject({
                            name: o.name,
                            error: "string" == typeof e ? e : e.toString(),
                          }))
  ...
  var x = new (class {
    ...
    loadWasm(s) {
      return e(this, void 0, void 0, function* () {
        null != s.params.resourceDir && a(this, b, s.params.resourceDir, "f"),
          ...
          if (s.params.module) {
            ...
            for (const r of a)
              if (
                ...
                yield a.promise,
                  e.modules.push({ name: r.name, wasmModule: a.wasmModule });
              }
            for (const r of a)
              if (
                !t(this, T, "f")[r.name] &&
          ...
          if ("object" == typeof a && s.params.module) {
            ...
            (r.modules = []),
              void 0 !== a.error
                ...
                : (r.errorMessage =
                    void 0 !== a.message ? a.message : "unknown error"),
              delete r.stack,
              r.modules.push({ name: a.name, wasmModule: null });
            for (const t of e)
              r.modules.push({ name: t.name, wasmModule: null });
          }
          t(this, D, "f").postMessage({ id: s.id, func: s.func, result: r }),
            e.reject(r);
        }
        return e.promise;
      });
    ...
    handleMessage(e) {
      ...
      let s = null;
      e.params && ((s = e.params.val), this.logDebug(e, "received " + e.func)),
        null != s && (W = s),
        a(this, I, W, "f");
      let r = e;
      if (
      ...
      let n = this.Module,
        i = this,
        l = { data: e, entryModule: n, context: this, wasmMemoryPtr: null };
      try {
        let a = null;
        if ("loadWasm" === e.func)
        ...
        if ((e.func, n)) {
          ...
          if (
            ...
            if (
              ...
              (a = n._malloc(s)),
                "[object ArrayBuffer]" === t
                  ? n.HEAPU8.set(new Uint8Array(e.params.input[0]), a)
                  : n.HEAPU8.set(new Uint8Array(e.params.input[0].buffer), a),
            ...
            (a = n._malloc(s)),
              "[object ArrayBuffer]" === t
                ? n.HEAPU8.set(new Uint8Array(e.params.input), a)
                : n.HEAPU8.set(new Uint8Array(e.params.input.buffer), a),
  ...
  (onmessage = function (e) {
    x.handleMessage(e.data);
  }),
    self.postMessage("ready");
  class N {}
  return (N.PdfReaderGlue = O), N;
});
