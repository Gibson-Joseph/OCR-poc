...
Dynamsoft.LTS._ = (function (t) {
  ...
  function (t, e, n) {
    ...
    function f(t, n, r) {
      ...
      if (
        ...
        S(n) && (c.indexOf("message") >= 0 || c.indexOf("description") >= 0))
      )
        return l(n);
      if (0 === c.length) {
        if (_(n)) {
    ...
    function p(t, e, n, r, o, i) {
      ...
      if (
        ((s = Object.getOwnPropertyDescriptor(e, o) || { value: e[o] }).get
          ...
          : s.set && (a = t.stylize("[Setter]", "special")),
        O(r, o) || (c = "[" + o + "]"),
        a ||
          (t.seen.indexOf(s.value) < 0
            ? (a = d(n) ? f(t, s.value, null) : f(t, s.value, n - 1)).indexOf(
                "\n"
              ) > -1 &&
              (a = i
                ? a
    ...
    (e.promisify = function (t) {
      ...
      (e.callbackify = function (t) {
        ...
        function e() {
          ...
          t.apply(this, e).then(
            function (t) {
              process.nextTick(i, null, t);
            },
            function (t) {
              process.nextTick(j, t, i);
            }
          );
        }
        return (
  ...
  function (t, e) {
    t.exports = function () {
      var t,
        ...
        n = null;
      "object" == typeof e[0]
        ? ((n = e.shift()), "string" == typeof (t = e.shift()) && (t = n[t]))
        : (t = e.shift());
      return function (r) {
        t.apply(n, e.concat(r));
      };
    };
  },
  function (t, e, n) {
    ...
    var r = n(4),
      ...
      a = r(n(14)),
      s = r(n(15));
    e.createLtsInstance = function (t) {
      var e,
        r = !!(
          "object" ==
            ("undefined" == typeof global
        ...
        u = t.dwt ? Dynamsoft.Lib.Promise : self.Promise,
        f =
          t.btoa ||
          (r
            ? global.btoa ||
      ...
      var h,
        ...
        F,
        D = t.product,
        U = ["https://mlts.dynamsoft.com/", "https://slts.dynamsoft.com/"],
        R = !1,
        z = u.resolve(),
        q = t.lf,
        B = t.log || function () {},
        G = t.dwt
          ? function (e) {
              try {
                t.debugLog && t.debugLog(e);
              } catch (t) {}
            }
          : t.debugLog || function () {},
        H = t.fol,
        J = t.sutlcb;
      Date.prototype.kUtilFormat = function (t) {
        var e = {
          ...
          new RegExp("(" + n + ")").test(t) &&
            (t = t.replace(
              ...
              1 == RegExp.$1.length
                ? e[n]
                : ("000" + e[n]).substr(
                    ("000" + e[n]).length - RegExp.$1.length
                  )
            ));
        return t;
      };
      var K,
        ...
        V = function () {
          return self[W(Z.c)][W(Z.e)][W(Z.f)](
            "raw",
            new Uint8Array(Z.a.concat(Z.b, Z.d, Z.k)),
            W(Z.g),
            !0,
            [W(Z.h), W(Z.i)]
          );
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        for (
                          r = l(e), i = new Uint8Array(r.length), a = 0;
                          a < r.length;
                          ++a
                        )
                          i[a] = r.charCodeAt(a);
                      ...
                      case 10:
                        return (
                          (t.next = 12),
                          self[W(Z.c)][W(Z.e)][W(Z.i)](
                            ((n = { name: W(Z.g) }),
                            (0, c.default)(n, W(Z.j), s),
                            (0, c.default)(n, W(Z.l), 128),
                            n),
                            F,
                            u
                          )
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        ...
                        for (
                          r = new Uint8Array(e.length), i = 0;
                          i < e.length;
                          ++i
                        )
                          r[i] = e.charCodeAt(i);
                        if (
                          ((a = self.crypto.getRandomValues(
                            new Uint8Array(12)
                          )),
                          F)
                        ) {
                      ...
                      case 8:
                        return (
                          (t.next = 10),
                          self[W(Z.c)][W(Z.e)][W(Z.h)](
                            ((n = { name: W(Z.g) }),
                            (0, c.default)(n, W(Z.j), a),
                            (0, c.default)(n, W(Z.l), 128),
                            n),
                            F,
                            r
                      ...
                      case 10:
                        return (
                          (s = t.sent),
                          (u = new Uint8Array(s)),
                          (l = new Uint8Array(a.length + u.length)).set(a),
                          l.set(u, a.length),
                          t.abrupt(
                            "return",
                            f(String.fromCharCode.apply(null, l))
                          )
                        );
                      case 16:
                      case "end":
        ...
        tt = function (t) {
          return l(l(t.replace(/\n/g, "+").replace(/\s/g, "=")).substring(1));
        },
        et = function (t) {
          return f(String.fromCharCode(97 + 25 * Math.random()) + f(t))
            .replace(/\+/g, "\n")
            .replace(/=/g, " ");
        },
        nt = function () {
          if (K) return K;
          if (self.crypto) {
            var t = new Uint8Array(36);
            self.crypto.getRandomValues(t);
            for (var e = "", n = 0; n < 36; ++n) {
              var r = t[n] % 36;
              e += r < 10 ? r : String.fromCharCode(r + 87);
            }
            return e;
          }
        ...
        rt =
          "Failed to connect to the License Tracking Server. The cached license has expired. Please get connected to the network as soon as possible or contact the site administrator for more information.",
        ot =
          "Failed to connect to the License Tracking Server: network timed out. Check your Internet connection or [contact Dynamsoft](https://www.dynamsoft.com/company/contact/) for more information.",
        it =
          "Failed to connect to the License Tracking Server: network timed out. Check your Internet connection or contact the site administrator for more information.",
        ct =
          "Failed to connect to the License Tracking Server: network connection error. Check your Internet connection or [contact Dynamsoft](https://www.dynamsoft.com/company/contact/) for more information.",
        at =
          "Failed to connect to the License Tracking Server: network connection error. Check your Internet connection or contact the site administrator for more information.",
        st =
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        n.feab && (X = n.feab),
                        (A = n.updateLicense),
                        (M = n.getMinExpireTime),
                        (N = n.getMaxExpireTime),
                        n.sutlcb && (J = n.sutlcb),
                        (t.next = 23),
                        ft()
                      );
                    ...
                    case 27:
                      return (
                        L || vt(null, !0), t.abrupt("return", { ar: g, cu: x })
                      );
                    case 29:
                    case "end":
                      return t.stop();
                      ...
                      case 0:
                        return (
                          q ||
                            self.localforage ||
                            (r
                              ? ((global.localforage = n(16).LocalStorage),
                                (global.localforage.prototype.keys =
                                  function () {
                                    for (
                                      var t = [], e = 0;
                                      e < this.length;
                                ...
                                (global.localforage.createInstance = function (
                                  t
                                ) {
                                  return new q("./dynamsoftverify/" + t.name);
                                }))
                              : importScripts("./localforage.min.js")),
                          (q = q || self.localforage),
                          r &&
                            ((global.fetch = global.fetch || n(39)),
                            (global.crypto = global.crypto || n(40).webcrypto)),
                          (W = function (t) {
                            return l(
                              String.fromCharCode
                                .apply(null, t)
                          ...
                          (t.prev = 3),
                          (t.next = 6),
                          q.createInstance({ name: D + "jshello" })
                        );
                      case 6:
                        return (
                          (e = t.sent),
                          (t.next = 9),
                          e.setItem(D + "jshello", "available")
                        );
                      case 9:
                        t.next = 14;
                        break;
                      case 11:
                        throw ((t.prev = 11), (t.t0 = t.catch(3)), t.t0);
                      case 14:
                        return (
                          (t.next = 16),
                          q.createInstance({ name: "dynamltsinfo" })
                        );
                      case 16:
                        if (
                          ((T = t.sent),
                          (I = K
                            ...
                            : f(
                                f("v2") +
                                  String.fromCharCode(
                                    b.charCodeAt(b.length / 2) + 1
                                  ) +
                                  f(b)
                              )),
                          (P = f(
                            String.fromCharCode((d || m).charCodeAt(0) + 10) +
                              f(D) +
                              f(d || m) +
                              y +
                              f(v)
                        ...
                        return (t.prev = 20), (t.next = 23), T.getItem(I);
                      case 23:
                        if (!(c = t.sent)) {
                          t.next = 33;
                          break;
                        }
                        return (t.t1 = JSON), (t.next = 28), tt(c);
                      case 28:
                        (t.t2 = t.sent),
                          (a = t.t1.parse.call(t.t1, t.t2)),
                          (s = (0, i.default)(a, 2)),
                          (x = s[0]),
                          (k = s[1]);
                      case 33:
                                  ...
                                  for (;;)
                                    switch ((n.prev = n.next)) {
                                      ...
                                      case 6:
                                        ...
                                        return (
                                          (n.t0 = JSON), (n.next = 11), tt(h)
                                        );
                                      case 11:
                                        (n.t1 = n.sent),
                                          (C = n.t0.parse.call(n.t0, n.t1)),
                                          (A = (0, i.default)(C, 2)),
                                          (x = A[0]),
                                          (k = A[1]);
                                      case 16:
                                      ...
                                      case 26:
                                        (n.prev = 26),
                                          ...
                                          e &&
                                            t.dwt &&
                                            self.console.error(n.t2),
                                          (L = n.t2);
                                      case 30:
                                        (j = new Date().kUtilFormat(
                                          "yyyy-MM-ddTHH:mm:ss.SSSZ"
                                        )),
                                          (Y = null);
                                      case 32:
                                  ...
                                  for (;;)
                                    switch ((n.prev = n.next)) {
                                      ...
                                      case 6:
                                        ...
                                        return (
                                          (n.t0 = JSON), (n.next = 25), Q(g)
                                        );
                                      case 25:
                                        (n.t1 = n.sent),
                                          (i = n.t0.parse.call(n.t0, n.t1))
                                            .ba && (r.ba = i.ba),
                                          i.usu && (r.usu = i.usu),
                                          i.trial && (r.trial = i.trial),
                                          i.its && (r.its = i.its),
                                          1 == r.trial && i.msg
                                            ? (r.msg = i.msg)
                                            : L
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        (e = new Date()),
                        (n = e.kUtilFormat("yyyy-MM-ddTHH:mm:ss.SSSZ")),
                        (t.next = 4),
                        N()
                      );
                    case 4:
                      if (((r = t.sent), G(r), !(r && r < n))) {
                        t.next = 12;
                        break;
                      }
                      if (!L) {
              ...
              return o.default.wrap(function (t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    ...
                    case 4:
                      return (r = t.sent), (t.next = 7), N();
                    case 7:
                      if (!((i = t.sent) && i < n)) {
                        t.next = 15;
                        break;
                      }
                      return (t.next = 11), lt(!0);
                    case 11:
                      return (t.next = 13), pt();
                    case 13:
                      t.next = 16;
                    ...
                    case 15:
                      r &&
                        r < n &&
                        (e.setMinutes(e.getMinutes() - 6),
                        (c = e),
                        (e = null),
                        (a = c.kUtilFormat("yyyy-MM-ddTHH:mm:ss.SSSZ")),
                        k < a &&
                          lt().then(function () {
                            return pt();
                          }));
        ...
        gt = (function () {
          var e = (0, a.default)(
            o.default.mark(function e(n, r, i, c) {
              var s;
              return o.default.wrap(
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 12:
                        ...
                        return (e.next = 16), C.setItem(i, s);
                      case 16:
                        e.next = 19;
                        break;
                      case 18:
                                    ...
                                    switch ((t.prev = t.next)) {
                                      ...
                                      case 22:
                                        ...
                                        return (
                                          ...
                                          (t.t3 = I),
                                          (t.next = 28),
                                          et(JSON.stringify([x, f]))
                                        );
                                      case 28:
                                        return (
                                          (t.t4 = t.sent),
                                          t.t2.setItem.call(t.t2, t.t3, t.t4),
                                          (t.next = 32),
                                          T.getItem(I)
                                        );
                                      case 32:
                                        ...
                                        return (
                                          (t.t5 = JSON), (t.next = 37), tt(l)
                                        );
                                      case 37:
                                        (t.t6 = t.sent),
                                          (p = t.t5.parse.call(t.t5, t.t6)),
                                          (h = (0, i.default)(p, 2)),
                                          (x = h[0]),
                                          (k = h[1]);
                                      case 42:
                                      ...
                                      case 51:
                                        ...
                                        return (
                                          (t.next = 54), C.removeItem(a[m])
                                        );
                                      case 54:
                                        ++m, (t.next = 51);
                                        break;
                                      case 57:
                                        return (t.next = 59), d.json();
                                      case 59:
                                        if (!(t.sent.handshakeUpdateTime > j)) {
                                          t.next = 65;
                                          break;
                                        }
                                        return (t.next = 63), lt(!0);
                                      case 63:
                                        return (t.next = 65), pt();
                                      case 65:
                                        t.next = 68;
      ...
      return { i: ut, c: yt, s: gt, caret: ht };
    };
  },
  function (t, e) {
  ...
  function (t, e, n) {
    var r = (function (t) {
      ...
      return (
        ...
        a(g, "constructor", h),
        a(h, "constructor", p),
        (p.displayName = a(h, c, "GeneratorFunction")),
  ...
  function (t, e, n) {
    (function () {
      ...
      (h = n(17)),
        ...
        (a = function (t) {
          var e, n, r, o, i;
          for (i = [], e = 0, n = (o = p.readdirSync(t)).length; e < n; e++)
            (r = o[e]), i.push(u(h.join(t, r)));
          return i;
        }),
        (u = function (t) {
          return p.statSync(t).isDirectory()
            ? (a(t), p.rmdirSync(t))
            : p.unlinkSync(t);
        }),
        (s = function (t) {
          return "" === t ? "---.EMPTY_STRING.---" : "" + t;
        }),
        (i = (function (t) {
          function e(t) {
            (this.message = null != t ? t : "Unknown error."),
        ...
        (c = function (t, e, n, r, o) {
          (this.key = t),
            ...
            (this.newValue = n),
            (this.url = r),
            (this.storageArea = null != o ? o : "localStorage");
        }),
        (o = function t(e, n) {
          if (((this.key = e), (this.index = n), !(this instanceof t)))
            return new t(this.key, this.index);
        }),
        (f = function () {
          var t;
          return (
            ((t = function () {}).prototype = Object.create(null)), new t()
          );
        }),
        (t = (function (t) {
          function e() {
          ...
          return (
            ...
            (e.prototype.setItem = function (t, n) {
              var r;
              return (
                (r = JSON.stringify(n)), e.__super__.setItem.call(this, t, r)
              );
            }),
            (e.prototype.getItem = function (t) {
              return JSON.parse(e.__super__.getItem.call(this, t));
            }),
            e
          );
        })(
          (r = (function (t) {
            ...
            function n(t, r) {
              ...
              return (
                (this._location = t),
                (this.quota = null != r ? r : 5242880),
                n.__super__.constructor.call(this),
                this instanceof n
                  ? ((this._location = h.resolve(this._location)),
                    null != e[this._location]
                      ? e[this._location]
                      : ((this.length = 0),
                        (this._bytesInUse = 0),
                        (this._keys = []),
                        ...
                        this._init(),
                        (this._QUOTA_EXCEEDED_ERR = i),
                        "undefined" != typeof Proxy && null !== Proxy
                          ? ((o = {
                              set:
                                ((c = this),
                                function (t, e, n) {
                              ...
                              get: (function (t) {
                                return function (e, n) {
                                  return null != t[n] ? t[n] : t.getItem(n);
                                };
                              })(this),
                            }),
                            (e[this._location] = new Proxy(this, o)),
                            e[this._location])
                          : ((e[this._location] = this), e[this._location])))
                  : new n(this._location, this.quota)
              );
            }
            return (
              d(n, t),
              ...
              (n.prototype._init = function () {
                var t, e, n, r, i, c, a, s, u;
                try {
                  if (
                    null != (u = p.statSync(this._location)) &&
                    !u.isDirectory()
                  )
                    throw new Error(
                      "A file exists at the location '" +
                        this._location +
                        "' when trying to create/open localStorage"
                    );
                  for (
                    this._bytesInUse = 0,
                      this.length = 0,
                      n = p.readdirSync(this._location),
                      c = i = 0,
                      s = n.length;
                    i < s;
                    c = ++i
                    ...
                    (a = n[c]),
                      ...
                      this._keys.push(e),
                      (t = new o(a, c)),
                      (this._metaKeyMap[e] = t),
                      null !=
                        (null != (u = this._getStat(a)) ? u.size : void 0) &&
                        ((t.size = u.size), (this._bytesInUse += u.size));
                  this.length = n.length;
                } catch (t) {
                  if ("ENOENT" !== (r = t).code) throw r;
                  try {
                    p.mkdirSync(this._location, { recursive: !0 });
                  } catch (t) {
                    if ("EEXIST" !== (r = t).code) throw r;
                  }
                }
              }),
              (n.prototype.setItem = function (t, e) {
                var n, r, a, u, f, l, p, d, m, g;
                if (
                  ((d = null),
                  (f = this.listenerCount("storage")) && (d = this.getItem(t)),
                  (t = s(t)),
                  (n = encodeURIComponent(t)
                    .replace(/[!'()]/g, escape)
                    .replace(/\*/g, "%2A")),
                  (u = h.join(this._location, n)),
                  (g = (m = "" + e).length),
                  (p = (a = !!(l = this._metaKeyMap[t])) ? l.size : 0),
                  this._bytesInUse - p + g > this.quota)
                )
                  throw new i();
                if (
                  (y(u, m, { encoding: "utf8" }),
                  a ||
                    (((l = new o(n, this._keys.push(t) - 1)).size = g),
                    (this._metaKeyMap[t] = l),
                    (this.length += 1),
                    (this._bytesInUse += g)),
                  f)
                )
                  return (
                    (r = new c(t, d, e, this._eventUrl)),
                    this.emit("storage", r)
                  );
              }),
              (n.prototype.getItem = function (t) {
                ...
                return (
                  (t = s(t)),
                  (n = this._metaKeyMap[t])
                    ? ((e = h.join(this._location, n.key)),
                      p.readFileSync(e, "utf8"))
                    : null
                );
              }),
              (n.prototype._getStat = function (t) {
                var e;
                (t = s(t)), (e = h.join(this._location, encodeURIComponent(t)));
                try {
                  return p.statSync(e);
                } catch (t) {
                  return null;
              ...
              (n.prototype.removeItem = function (t) {
                var e, n, r, o, i, a, f, l;
                if (((t = s(t)), (a = this._metaKeyMap[t]))) {
                  for (o in ((f = null),
                  (r = this.listenerCount("storage")) && (f = this.getItem(t)),
                  delete this._metaKeyMap[t],
                  (this.length -= 1),
                  (this._bytesInUse -= a.size),
                  (n = h.join(this._location, a.key)),
                  this._keys.splice(a.index, 1),
                  (l = this._metaKeyMap)))
                    l[o],
                      (i = this._metaKeyMap[o]).index > a.index &&
                        (i.index -= 1);
                  if ((u(n), r))
                    return (
                      (e = new c(t, f, null, this._eventUrl)),
                      this.emit("storage", e)
                    );
                }
              }),
              (n.prototype.key = function (t) {
                var e;
                return "---.EMPTY_STRING.---" === (e = this._keys[t]) ? "" : e;
              }),
              (n.prototype.clear = function () {
                ...
                if (
                  ...
                  (this.length = 0),
                  (this._bytesInUse = 0),
                  this.listenerCount("storage"))
                )
                  return (
                    (t = new c(null, null, null, this._eventUrl)),
                    this.emit("storage", t)
                  );
              }),
              (n.prototype._getBytesInUse = function () {
                return this._bytesInUse;
              }),
              (n.prototype._deleteLocation = function () {
                return (
                  delete e[this._location],
                  u(this._location),
                  (this._metaKeyMap = {}),
                  (this._keys = []),
                  (this.length = 0),
        ...
        if (n === e || n.listener === e)
          ...
          0 === o
            ...
            void 0 !== r.removeListener &&
              this.emit("removeListener", t, c || e);
        }
        return this;
      }),
  ...
  function (t, e, n) {
    ...
    (t.exports = function (t, e, n, i) {
      n instanceof Function && ((i = n), (n = null));
      n || (n = {});
      r.realpath(t, function (a, u) {
        !(function (t, e, n, i) {
          var a = s(t);
          return n.mode && n.chown
            ? u()
            : r.stat(t, function (t, e) {
                return (
                  t ||
                    !e ||
                    ((n = c({}, n)).mode || (n.mode = e.mode),
                    !n.chown &&
                      process.getuid &&
          ...
          function u() {
            o(
              [
                [f, a, e, n.mode, n.encoding || "utf8"],
                n.chown && [r, r.chown, a, n.chown.uid, n.chown.gid],
                n.mode && [r, r.chmod, a, n.mode],
                [r, r.rename, a, t],
              ],
              function (t) {
                t
          ...
          function f(t, e, o, i, c) {
            r.open(t, "w", n.mode, function (t, n) {
              return t
                ? c(t)
                : Buffer.isBuffer(e)
                ? r.write(n, e, 0, e.length, 0, o)
                : null != e
                ? r.write(n, String(e), 0, String(i), o)
                : o();
              function o(t) {
                if (t) return c(t);
                r.fsync(n, function (t) {
                  if (t) return c(t);
                  r.close(n, c);
                });
              }
      ...
      (t.exports.sync = function (t, e, n) {
        ...
        try {
          if (!n.mode || !n.chown)
            try {
              var i = r.statSync(t);
              (n = c({}, n)).mode || (n.mode = i.mode),
                !n.chown &&
                  process.getuid &&
                  (n.chown = { uid: i.uid, gid: i.gid });
            } catch (t) {}
          var a = r.openSync(o, "w", n.mode);
          Buffer.isBuffer(e)
            ? r.writeSync(a, e, 0, e.length, 0)
            : null != e &&
              r.writeSync(a, String(e), 0, String(n.encoding || "utf8")),
            r.fsyncSync(a),
            r.closeSync(a),
            n.chown && r.chownSync(o, n.chown.uid, n.chown.gid),
            n.mode && r.chmodSync(o, n.mode),
            r.renameSync(o, t);
        } catch (t) {
          try {
            r.unlinkSync(o);
      ...
      (t.exports._getTmpname = s);
    var r = n(20),
      o = n(35).chain,
      i = n(38),
      c = Object.assign || n(1)._extend,
      a = 0;
    function s(t) {
      return (
        t +
  ...
  function (t, e, n) {
    ...
    if (
      ...
      f(i, h),
        (i.close = (function (t) {
          function e(e, n) {
            return t.call(i, e, function (t) {
              t || m(), "function" == typeof n && n.apply(this, arguments);
            });
          }
        ...
        (i.closeSync = (function (t) {
          function e(e) {
            t.apply(i, arguments), m();
          }
          return Object.defineProperty(e, o, { value: t }), e;
        })(i.closeSync)),
        /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") &&
          process.on("exit", function () {
            p(i[r]), n(30).equal(i[r].length, 0);
          });
    }
    function y(t) {
      c(t),
        ...
        return (function t(n, r, o, i) {
          return e(n, r, function (e) {
            !e || ("EMFILE" !== e.code && "ENFILE" !== e.code)
              ...
              : d([t, [n, r, o], e, i || Date.now(), Date.now()]);
          });
        })(t, n, r);
      };
      var n = t.writeFile;
      ...
      r &&
        (t.appendFile = function (t, e, n, o) {
          ...
          return (function t(e, n, o, i, c) {
            return r(e, n, o, function (r) {
              !r || ("EMFILE" !== r.code && "ENFILE" !== r.code)
                ? "function" == typeof i && i.apply(this, arguments)
                : d([t, [e, n, o, i], r, c || Date.now(), Date.now()]);
            });
          })(t, e, n, o);
        });
      var o = t.copyFile;
          ...
          return (function t(e, n, r, i, c) {
            return o(e, n, r, function (o) {
              !o || ("EMFILE" !== o.code && "ENFILE" !== o.code)
                ? "function" == typeof i && i.apply(this, arguments)
                : d([t, [e, n, r, i], o, c || Date.now(), Date.now()]);
            });
          })(t, e, n, r);
        });
      var i = t.readdir;
      t.readdir = function (t, e, n) {
        ...
        var r = s.test(process.version)
          ? function (t, e, n, r) {
              return i(t, o(t, e, n, r));
            }
          : function (t, e, n, r) {
              return i(t, e, o(t, e, n, r));
            };
        return r(t, e, n);
        function o(t, e, n, o) {
          return function (i, c) {
            !i || ("EMFILE" !== i.code && "ENFILE" !== i.code)
              ...
              : d([r, [t, e, n], i, o || Date.now(), Date.now()]);
          };
        }
      };
      var s = /^v[0-5]\./;
      if ("v0.8" === process.version.substr(0, 4)) {
        var u = a(t);
        (m = u.ReadStream), (g = u.WriteStream);
      }
      var f = t.ReadStream;
      f &&
        ...
        (m.prototype.open = function () {
          var t = this;
          b(t.path, t.flags, t.mode, function (e, n) {
            e
      ...
      function b(t, e, n, r) {
        return (
          ...
          (function t(e, n, r, o, i) {
            return v(e, n, r, function (c, a) {
              !c || ("EMFILE" !== c.code && "ENFILE" !== c.code)
                ? "function" == typeof o && o.apply(this, arguments)
                : d([t, [e, n, r, o], c, i || Date.now(), Date.now()]);
            });
          })(t, e, n, r)
        );
      }
    ...
    function d(t) {
      p("ENQUEUE", t[0].name, t[1]), i[r].push(t), g();
    }
    function m() {
      for (var t = Date.now(), e = 0; e < i[r].length; ++e)
        i[r][e].length > 2 && ((i[r][e][3] = t), (i[r][e][4] = t));
      g();
    }
    function g() {
      if ((clearTimeout(l), (l = void 0), 0 !== i[r].length)) {
        var t = i[r].shift(),
          ...
          c = t[3],
          a = t[4];
        if (void 0 === c) p("RETRY", e.name, n), e.apply(null, n);
        else if (Date.now() - c >= 6e4) {
          p("TIMEOUT", e.name, n);
          var s = n.pop();
          "function" == typeof s && s.call(null, o);
        } else {
          var u = Date.now() - a,
            f = Math.max(a - c, 1);
          u >= Math.min(1.2 * f, 100)
            ? (p("RETRY", e.name, n), e.apply(null, n.concat([c])))
            : i[r].push(t);
        }
        void 0 === l && (l = setTimeout(g, 0));
      }
    }
        ...
        (function (t) {
          (t.lchmod = function (e, n, o) {
            ...
            (t.lchmodSync = function (e, n) {
              var o,
                i = t.openSync(e, r.O_WRONLY | r.O_SYMLINK, n),
                c = !0;
              try {
                (o = t.fchmodSync(i, n)), (c = !1);
              } finally {
                if (c)
                  try {
                    t.closeSync(i);
            ...
            : (function (e) {
                function n(n, r, o) {
                  ...
                  e(n, r, function a(s) {
                    if (
                      s &&
                      ("EACCES" === s.code || "EPERM" === s.code) &&
                      Date.now() - i < 6e4
                    )
                      return (
                        setTimeout(function () {
                          t.stat(r, function (t, i) {
                            t && "ENOENT" === t.code ? e(n, r, a) : o(s);
                          });
                        }, c),
                        void (c < 100 && (c += 10))
                      );
        ...
        return e
          ? function (n, r, o) {
              return e.call(t, n, r, function (t) {
                u(t) && (t = null), o && o.apply(this, arguments);
              });
            }
          : e;
      }
        ...
        return e
          ? function (n, r, o, i) {
              return e.call(t, n, r, o, function (t) {
                u(t) && (t = null), i && i.apply(this, arguments);
              });
            }
          : e;
      }
                ...
                if (a && "function" == typeof a) {
                  ...
                  s = function (f, l, p) {
                    if (f && "EAGAIN" === f.code && u < 10)
                      return u++, e.call(t, n, r, o, i, c, s);
                    a.apply(this, arguments);
                  };
                }
                return e.call(t, n, r, o, i, c, s);
              }
              return Object.setPrototypeOf && Object.setPrototypeOf(n, e), n;
            })(t.read)),
        (t.readSync =
  ...
  function (t, e) {
    (t.exports = function (e) {
      return t.exports.definer(e);
    }),
      (t.exports.define = function (e, n, r) {
        var o;
        if ("object" == typeof n)
          for (o in n) n.hasOwnProperty(o) && t.exports.define(e, o, n[o]);
        else
      ...
      (t.exports.definer = function (e) {
        return (
          (e = e || Object.create(null)),
          function (n, r) {
            return t.exports.define(e, n, r);
          }
        );
      });
  },
      ...
      return {
        ReadStream: function e(n, o) {
          ...
          (this.path = n),
            ...
            (o = o || {});
          for (var c = Object.keys(o), a = 0, s = c.length; a < s; a++) {
            var u = c[a];
            this[u] = o[u];
          }
        ...
        WriteStream: function e(n, o) {
          ...
          r.call(this),
            ...
            (this.bytesWritten = 0),
            (o = o || {});
          for (var i = Object.keys(o), c = 0, a = i.length; c < a; c++) {
            var s = i[c];
            this[s] = o[s];
          }
          if (void 0 !== this.start) {
  ...
  function (t, e, n) {
    ...
    (o.prototype = new r()),
      ...
      (o.prototype.pipe = function (t, e) {
        ...
        function s(t) {
          if ((u(), !this.hasListeners("error"))) throw t;
        }
        function u() {
          n.off("data", r),
            t.off("drain", o),
  ...
  function (t, e, n) {
    ...
    function m(t) {
      if (u || !c.isFunction(t)) return c.inspect(t);
      var e = y(t);
      return "[Function" + (e ? ": " + e : "") + "]";
    }
      ...
      if (
        ...
        return (
          ...
          (function (t, e, n, r) {
            ...
            if (c.isPrimitive(t) || c.isPrimitive(e)) return t === e;
            if (n && Object.getPrototypeOf(t) !== Object.getPrototypeOf(e))
              return !1;
            var o = x(t),
              i = x(e);
            if ((o && !i) || (!o && i)) return !1;
            if (o) return (t = s.call(t)), (e = s.call(e)), b(t, e, n);
            var a,
              u,
              f = _(t),
              l = _(e);
            if (f.length !== l.length) return !1;
            for (f.sort(), l.sort(), u = f.length - 1; u >= 0; u--)
              if (f[u] !== l[u]) return !1;
            for (u = f.length - 1; u >= 0; u--)
              if (((a = f[u]), !b(t[a], e[a], n, r))) return !1;
            return !0;
          })(t, e, n, r))
        );
      }
    ...
    (p.AssertionError = function (t) {
      ...
      c.inherits(p.AssertionError, Error),
      (p.fail = g),
      (p.ok = v),
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (t, e, n) {
    ...
    function u(t, n, r) {
      ...
      if (
        (t.showHidden && (c = Object.getOwnPropertyNames(n)),
        w(n) && (c.indexOf("message") >= 0 || c.indexOf("description") >= 0))
      )
        return f(n);
      if (0 === c.length) {
        if (S(n)) {
      ...
      return (
        v(n) && (_ = " " + RegExp.prototype.toString.call(n)),
        x(n) && (_ = " " + Date.prototype.toUTCString.call(n)),
        w(n) && (_ = " " + f(n)),
        0 !== c.length || (O && 0 != n.length)
          ? r < 0
            ? v(n)
              ? t.stylize(RegExp.prototype.toString.call(n), "regexp")
              : t.stylize("[Object]", "special")
    ...
    function l(t, e, n, r, o, i) {
      ...
      if (
        ...
        a ||
          (t.seen.indexOf(s.value) < 0
            ? (a = y(n) ? u(t, s.value, null) : u(t, s.value, n - 1)).indexOf(
                "\n"
              ) > -1 &&
              (a = i
                ? a
    ...
    function v(t) {
      return b(t) && "[object RegExp]" === _(t);
    }
    function b(t) {
      return "object" == typeof t && null !== t;
    }
    function x(t) {
      return b(t) && "[object Date]" === _(t);
    }
    function w(t) {
      return b(t) && ("[object Error]" === _(t) || t instanceof Error);
    }
    function S(t) {
      return "function" == typeof t;
    }
  ...
  function (t, e, n) {
    (e.asyncMap = n(36)), (e.bindActor = n(2)), (e.chain = n(37));
  },
  function (t, e) {
    t.exports = function () {
      ...
      function s(u) {
        u && !i && (i = u);
        for (var f = arguments.length, l = 1; l < f; l++)
          void 0 !== arguments[l] &&
            (o[l - 1] = (o[l - 1] || []).concat(arguments[l]));
        if (e.length > c) {
          var p = e.slice(c);
          (a += (e.length - c) * r),
            (c = e.length),
      ...
      !(function i(c, a) {
        return c >= a
          ...
          : (Array.isArray(t[c]) &&
            ...
            t[c]
              ? void t[c](function (t, r) {
                  if (t) return e(t, n);
                  void 0 !== r && (n = n.concat(r)), i(c + 1, a);
                })
              : i(c + 1, a));
      })(0, t.length);
    }
  ...
  function (t, e, n) {
    ...
    !(function () {
      var e;
      function n(t, r) {
        var o = this instanceof n ? this : e;
        if (
          (o.reset(r),
          "string" == typeof t && t.length > 0 && o.hash(t),
          o !== this)
        )
          return o;
      }
      (n.prototype.hash = function (t) {
        var e, n, r, o, i;
        switch (
          ((i = t.length), (this.len += i), (n = this.k1), (r = 0), this.rem)
        ) {
          case 0:
            n ^= i > r ? 65535 & t.charCodeAt(r++) : 0;
          case 1:
            n ^= i > r ? (65535 & t.charCodeAt(r++)) << 8 : 0;
          case 2:
            n ^= i > r ? (65535 & t.charCodeAt(r++)) << 16 : 0;
          case 3:
            (n ^= i > r ? (255 & t.charCodeAt(r)) << 24 : 0),
              (n ^= i > r ? (65280 & t.charCodeAt(r++)) >> 8 : 0);
        }
        if (((this.rem = (i + this.rem) & 3), (i -= this.rem) > 0)) {
          for (
            e = this.h1;
            (e =
              (5 *
            ...
            (n =
              ...
              (n ^=
                ((255 & (o = t.charCodeAt(r++))) << 24) ^ ((65280 & o) >> 8));
          switch (((n = 0), this.rem)) {
            case 3:
              n ^= (65535 & t.charCodeAt(r + 2)) << 16;
            case 2:
              n ^= (65535 & t.charCodeAt(r + 1)) << 8;
            case 1:
              n ^= 65535 & t.charCodeAt(r);
          }
          this.h1 = e;
        }
        ...
        (n.prototype.result = function () {
          ...
          return (
            ...
            t > 0 &&
              (e ^= t =
                (13715 *
                  (t =
                    ((t =
                      (11601 * t + 3432906752 * (65535 & t)) & 4294967295) <<
                      15) |
                    (t >>> 17)) +
                  461832192 * (65535 & t)) &
                4294967295),
            (e ^= this.len),
            (e =
              (51819 * (e ^= e >>> 16) + 2246770688 * (65535 & e)) &
              4294967295),
            (e =
              (44597 * (e ^= e >>> 13) + 3266445312 * (65535 & e)) &
              4294967295),
            (e ^= e >>> 16) >>> 0
          );
        }),
